...
class BorrowControllerTest {
    ...
    void shouldReturnAllBarrow() {
        ...
        when(borrowApplication.getAllBorrows()).thenReturn(List.of(borrowDTO));

        //when
        var result = borrowController.getAllBorrows();
        //then
    ...
    void shouldReturnBarrowById() {
        ...
        when(borrowApplication.getBorrowsById(id)).thenReturn(borrowDTO);

        //when
        var result = borrowController.getBorrowsById(id);
    ...
    void shouldAddBarrow() {
        ...
        when(borrowApplication.addBorrow(borrowCreateDTO)).thenReturn(message);

        //when
        var result = borrowController.addBorrow(borrowCreateDTO);
    ...
    void shouldUpdateBorrowAndReturnBook() {
        ...
        when(borrowApplication.updateBorrowAndReturnBook(barrowId)).thenReturn(message);

        //when
        var result = borrowController.updateBorrowAndReturnBook(barrowId);
    ...
    void shouldChargePenalty() {
        ...
        when(borrowApplication.chargePenalty(barrowId)).thenReturn(message);

        //when
        var result = borrowController.chargePenalty(barrowId);
    ...
    void shouldSendEmail() {
        ...
        when(borrowApplication.sendEmail()).thenReturn(List.of(borrowDTO));

        //when
        var result = borrowController.sendEmail();
